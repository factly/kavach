export default {
	...
	"ui": {
			"action": "https://kratos.factly.in/self-service/settings?flow=4e805483-a767-49cd-b363-49d96ff0e0f6",
			"method": "POST",
			"nodes": [
					{
							"type": "input",
							...
							"attributes": {
									"name": "csrf_token",
									"type": "hidden",
									"value": "r+4GbePj6Y9TbRNai/US2xarhPb90PNc+s9q+Cnah7/hevhpPLbOu7Lu6ibsk+Q0SkqZ6BwgQ9rRk2BrOl6eig==",
									"required": true,
									"disabled": false,
									"node_type": "input"
							},
