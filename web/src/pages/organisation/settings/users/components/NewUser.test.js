    ...
    it('should call add user when 1 user is added', (done) => {
      ...
      act(() => {
        component
          .find('input')
          .at(0)
          .simulate('change', { target: { value: 'testemail@gmail.com' } });
        component
          .find('input')
          .at(1)
        ...
        component
          .find('input')
          .at(2)
          .simulate('change', { target: { value: 'last' } });
    ...
    it('should call add user when multiple users are added', (done) => {
      ...
      act(() => {
        ...
        component
          .find('input')
          .at(4)
          .simulate('change', { target: { value: 'testemail2@gmail.com' } });
        component
          .find('input')
          .at(5)
          .simulate('change', { target: { value: 'first2' } });
        component
          .find('input')
          .at(6)
          .simulate('change', { target: { value: 'last2' } });
