...
describe('Organisation Form', () => {
  ...
  describe('Snapshot tests', () => {
    ...
    it(
      description + "when loading is false REACT_APP_ENABLE_MULTITENANCY is 'false' orgCount >= 1",
      () => {
    ...
    it(
      description + "when loading is false REACT_APP_ENABLE_MULTITENANCY is 'true' orgCount < 1",
      () => {
