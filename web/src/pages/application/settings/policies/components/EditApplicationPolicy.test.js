...
import { updateApplicationPolicy } from '../../../../../actions/policy';
...
jest.mock('../../../../../components/Policies', () => {
  return jest.fn((props) => <div id="mockPolicies" {...props} />);
});
    ...
    it('should call the updateApplicationPolicy action with the correct params', (done) => {
      ...
      act(() => {
        ...
        wrapper
          ...
          .at(0)
          .props()
          .onChange({ target: { value: 1, label: 'Test Role 1' } });
        // submit form
        wrapper.find('form').simulate('submit');
      });
      setTimeout(() => {
        expect(mockedDispatch).toHaveBeenCalledWith(
          updateApplicationPolicy(1, {
            name: 'test-name',
            slug: 'test-slug',
            description: 'test-description',
            roles: [1],
