...
describe('role user actions', () => {
  ...
  it(testDescription + 'getApplicationRoleUsers success', () => {
    ...
    expect(axios.get).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/applications/${appID}/roles/${roleID}/users`,
    );
  });
  ...
  it(testDescription + 'getSpaceRoleUsers success', () => {
    ...
    expect(axios.get).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/roles/${roleID}/users`,
    );
  });
  ...
  it(testDescription + 'addOrganisationRoleUserByID success', () => {
    ...
    expect(axios.post).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/roles/${roleID}/users`,
      data,
    );
  });
  ...
  it(testDescription + 'deleteOrganisationRoleUserByID success', () => {
    ...
    expect(axios.delete).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/roles/${roleID}/users/${userID}`,
    );
  });
  ...
  it(testDescription + 'deleteApplicationRoleUserByID success', () => {
    ...
    expect(axios.delete).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/applications/${appID}/roles/${roleID}/users/${userID}`,
    );
  });
  ...
  it(testDescription + 'deleteSpaceRoleUserByID success', () => {
    ...
    expect(axios.delete).toHaveBeenCalledWith(
      `${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/roles/${roleID}/users/${userID}`,
    );
  });
