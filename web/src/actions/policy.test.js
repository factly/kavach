...
describe('profile actions', () => {
	...
	it(testDescription + 'updateOrganisationPolicy success', () => {
		...
		expect(axios.put).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/policy/${policy.id}`, policy);
	});
	...
	it(testDescription + 'getApplicationPolicy success', () => {
		...
		const spaceID = 1;
		const appID = 1;
		const roles = [{ id: 1, name: 'test' }, { id: 2, name: 'test2' }];
		const policies = [{ id: 1, name: 'test', roles }, { id: 2, name: 'test2', roles }];
		...
		expect(axios.get).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/policy`);
	});
	...
	it(testDescription + 'getApplicationPolicyByID success', () => {
		...
		const appID = 1;
		const policyID = 1;
		const policy = { id: 1, name: 'test', roles: [{ id: 1, name: 'test' }, { id: 2, name: "test2" }] };
		axios.get.mockResolvedValue({ data: policy });
		const expectedActions = [
			{
				type: types.POLICY_LOADING,
		...
		expect(axios.get).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/policy/${policyID}`);
	});
	...
	it(testDescription + 'createApplicationPolicy success', () => {
		...
		expect(axios.post).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/policy`, policy);
	});
	...
	it(testDescription + 'updateApplicationPolicy success', () => {
		...
		expect(axios.put).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/policy/${policy.id}`, policy);
	});
	...
	it(testDescription + 'deleteApplicationPolicy success', () => {
		...
		expect(axios.delete).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/policy/${policyID}`);
	});
	...
	it(testDescription + 'getSpacePolicy success', () => {
		...
		const spaceID = 1;
		const appID = 1;
		const policy = { id: 1, name: 'test', roles: [{ id: 1, name: 'test' }, { id: 2, name: "test 2" }] };
		...
		expect(axios.get).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/policy`);
	});
	...
	it(testDescription + 'getSpacePolicyByID success', () => {
		...
		expect(axios.get).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/policy/${policyID}`);
	});
	...
	it(testDescription + 'createSpacePolicy success', () => {
		...
		expect(axios.post).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/policy`, policy);
	});
	...
	it(testDescription + 'updateSpacePolicy success', () => {
		...
		expect(axios.put).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/policy/${policyID}`, policy);
	});
	...
	it(testDescription + 'deleteSpacePolicy success', () => {
		...
		expect(axios.delete).toHaveBeenCalledWith(`${ORGANISATIONS_API}/${orgID}/applications/${appID}/spaces/${spaceID}/policy/${policyID}`);
	});
