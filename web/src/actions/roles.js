...
export const addOrganisationRoleByID = (data) => ({
	type: ADD_ORGANISATION_ROLE_BY_ID,
	payload: data
})

export const addApplicationRoleByID = (appID, data) => ({
...
export const addSpaceRoleByID = (spaceID, data) => ({
  ...
  return (dispatch, getState) => {
    ...
    return axios
      ...
      .then((res) => {
        ...
        dispatch(addOrganisationRoles(getState().organisations.selected, buildObjectOfItems(res.data)));
    ...
    return axios
      ...
      .then((res) => {
        ...
        res.data.users = getIds(res.data.users);
				dispatch(addOrganisationRoleByID(res.data))
      })
      .catch((error) => {
        dispatch(addErrorNotification(error.message));
      })
...
export const getApplicationRoles = (appID) => {
	return (dispatch, getState) => {
        ...
        dispatch(addApplicationRoles(buildObjectOfItems(res.data)));
        const roleIDs = getIds(res.data);
...
export const createApplicationRole = (appID, data) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .post(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/roles`, data)
      .then(() => {
        dispatch(addSuccessNotification('Role Added Successfully'));
      })
      .catch((error) => {
...
export const deleteApplicationRole = (appID, roleID) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .delete(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/roles/${roleID}`)
      .then(() => {
        dispatch(addSuccessNotification('Role Deleted Successfully'));
      })
      .catch((error) => {
...
export const getApplicationRoleByID = (appID, roleID) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .get(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/roles/${roleID}`)
      .then((res) => {
        deleteKeys([res.data], ['application']);
        res.data.users = getIds(res.data.users);
				dispatch(addApplicationRoleByID(appID, res.data))
      })
      .catch((error) => {
        dispatch(addErrorNotification(error.message));
      })
...
export const updateApplicationRole = (id, appID, data) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .put(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/roles/${id}`, data)
      .then(() => {
        dispatch(addSuccessNotification('Role Updated Successfully'));
      })
      .catch((error) => {
...
export const getSpaceRoles = (appID, spaceID) => {
	return (dispatch, getState) => {
		dispatch(startLoadingRoles())
		return axios
			.get(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/spaces/${spaceID}/roles`)
			.then((res)=>{
				deleteKeys(res.data, ['space']);
        res.data.forEach((role) => {
          role.users = getIds(role.users);
        });
        dispatch(addSpaceRoles(buildObjectOfItems(res.data)));
        const roleIDs = getIds(res.data);
...
export const createSpaceRole = (appID, spaceID, data) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .post(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/spaces/${spaceID}/roles`, data)
      .then(() => {
        dispatch(addSuccessNotification('Role Added Successfully'));
      })
      .catch((error) => {
...
export const deleteSpaceRole = (appID, spaceID, roleID) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .delete(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/spaces/${spaceID}/roles/${roleID}`)
      .then(() => {
        dispatch(addSuccessNotification('Role Deleted Successfully'));
      })
      .catch((error) => {
...
export const getSpaceRoleByID = (appID, spaceID, roleID) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .get(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/spaces/${spaceID}/roles/${roleID}`)
      .then((res) => {
        deleteKeys([res.data], ['space']);
        res.data.users = getIds(res.data.users);
				dispatch(addSpaceRoleByID(spaceID, res.data))
      })
      .catch((error) => {
        dispatch(addErrorNotification(error.message));
      })
...
export const updateSpaceRole = (id, appID, spaceID, data) => {
  return (dispatch, getState) => {
    dispatch(startLoadingRoles());
    return axios
      .put(`${ORGANISATIONS_API}/${getState().organisations.selected}/applications/${appID}/spaces/${spaceID}/roles/${id}`, data)
      .then(() => {
        dispatch(addSuccessNotification('Role Updated Successfully'));
      })
      .catch((error) => {
