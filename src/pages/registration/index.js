...
function Registration() {
  ...
  React.useEffect(() => {
    ...
    fetch(
      process.env.REACT_APP_KRATOS_PUBLIC_URL + "/self-service/browser/flows/requests/registration?request=" + obj["request"]
    )
      .then(res => res.json())
    ...
    <div className="container">
      <div className="content">
        ...
        <div className="registration-form">
          <Title level={3} className="registration-form-title">Admin Registration</Title>
          <Form
