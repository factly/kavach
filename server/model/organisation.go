...
type Organisation struct {
	...
	FeaturedMediumID *uint   `gorm:"column:featured_medium_id;default:NULL;type:SERIAL4;" json:"featured_medium_id"`
...
type OrganisationUser struct {
	Base
	UserID         uint          `gorm:"column:user_id;type:SERIAL4;" json:"user_id"`
	User           *User         `json:"user"`
	OrganisationID uint          `gorm:"column:organisation_id;type:SERIAL4;" json:"organisation_id"`
