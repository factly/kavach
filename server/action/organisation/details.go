...
func details(w http.ResponseWriter, r *http.Request) {
	...
	err = model.DB.Model(&model.Organisation{}).Preload("Medium").Preload("Applications").Preload("OrganisationUsers").Preload("OrganisationUsers.User").Preload("Roles").Preload("Roles.Users").First(&organisation).Error
